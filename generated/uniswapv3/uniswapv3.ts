...
export class uniswapv3__parametersResult {
  value0: Address;
  value1: Address;
  value2: Address;
  value3: i32;
...
export class uniswapv3 extends ethereum.SmartContract {
  static bind(address: Address): uniswapv3 {
    return new uniswapv3("uniswapv3", address);
  }
  ...
  parameters(): uniswapv3__parametersResult {
    let result = super.call(
      "parameters",
    ...
    return new uniswapv3__parametersResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toAddress(),
      result[3].toI32(),
  ...
  try_parameters(): ethereum.CallResult<uniswapv3__parametersResult> {
    let result = super.tryCall(
      "parameters",
      "parameters():(address,address,address,uint24,int24)",
      []
    ...
    return ethereum.CallResult.fromValue(
      new uniswapv3__parametersResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toAddress(),
        value[3].toI32(),
