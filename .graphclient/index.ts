...
import type { UniSwapHistoricalPriceTypes } from './sources/UniSwap Historical Price/types';
...
export type MeshContext = UniSwapHistoricalPriceTypes.Context & BaseMeshContext;
