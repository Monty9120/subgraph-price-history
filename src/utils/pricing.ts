...
import { BigDecimal, BigInt, log, json } from '@graphprotocol/graph-ts'
import { exponentToBigDecimal, safeDiv } from '../utils/index'

const WETH_ADDRESS = '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2'
// const USDC_WETH_03_POOL = '0x8ad599c3a0ff1de082011efddc58f1908eb6e6d8'
const USDC_WETH_03_POOL = '0xb4e16d0168e52d35cacd2c6185b44281ec28c9dc'
...
export function getEthPriceInUSD(): BigDecimal {
  ...
  if (usdcPool) {
    log.debug('usdcPool: {}', [usdcPool.token0Price.toString()]);

  } else {
    log.debug('usdcPool: {}', ['no USDC pool!'])
